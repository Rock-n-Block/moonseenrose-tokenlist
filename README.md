# moonseenrose-tokenlist

### Whitelisting instructions

- Fork this repo
  ```
  gh repo clone Rock-n-Block/moonseenrose-tokenlist
  ```
...
- Add token's info in the *tokenlist.json* file, in this format:
  ```
  {
      ...
      "chainId": 1284,
      "logoURI": "https://raw.githubusercontent.com/Rock-n-Block/moonseenrose-tokenlist/master/assets/chains/[blockchainName]/[token_address]/logo.png"
  }
  ```
